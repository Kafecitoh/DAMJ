...
class ClienteMal {
    ...
    // Constructor
    public ClienteMal(String nombre, String direccion, String telefono, double saldo) {
        this.nombre = nombre;
    ...
    public static void main(String[] args) {
        ...
        ClienteMal cliente = new ClienteMal("Juan Pérez", "Calle Falsa 123", "555-1234", 500.0);
